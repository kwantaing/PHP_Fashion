...
include_once(APP_NON_WEB_BASE_DIR .'controllers/PostController.php');
...
include_once(APP_NON_WEB_BASE_DIR .'db/PostDAM.php');
include_once(APP_NON_WEB_BASE_DIR .'models/User.php');
include_once(APP_NON_WEB_BASE_DIR .'models/Post.php');
...
include_once(APP_NON_WEB_BASE_DIR .'viewModels/PostVM.php');
